...
export const GRAYSCALE_LIGHTENED_BACKGROUND = '#35383A';
export const GRAYSCALE_DARKENED_BACKGROUND = '#0d1012';
export const GRAYSCALE_DISABLED = '#8B8E90';
export const GRAYSCALE_EMPHASIZE_BORDER = '#373b3f';
export const GRAYSCALE_EMPHASIZE_BACKGROUND = '#2c3235';

export const COLORFUL_EMPHASIZE_BORDER = '#6c7494';
