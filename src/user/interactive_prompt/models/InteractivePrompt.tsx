...
export type InteractiveColorPrompt = InteractivePromptBase & {
  prompt: ColorPrompt;
};
export type InteractiveWordPrompt = InteractivePromptBase & {
  prompt: WordPrompt;
};
export type InteractiveNumericPrompt = InteractivePromptBase & {
