...
type InteractivePromptRouterColorProps = InteractivePromptRouterPropsBase<
  string | null
> & {
  prompt: InteractiveColorPrompt;
};

type InteractivePromptRouterWordProps = InteractivePromptRouterPropsBase<
  string | null
> & {
  prompt: InteractiveWordPrompt;
};

type InteractivePromptRouterNumericProps = InteractivePromptRouterPropsBase<
  number | null
> & {
  prompt: InteractiveNumericPrompt;
};

type InteractivePromptRouterGenericProps =
  InteractivePromptRouterPropsBase<unknown> & {
...
export const InteractivePromptRouter = (
  props: InteractivePromptRouterProps
): ReactElement => {
