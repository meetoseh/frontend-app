...
export const useIndexableFakeMove = ({
  ...
  const responsesVWC = useVariableStrategyPropsAsValueWithCallbacks(
    responsesVariableStrategy
  );
  const selectionVWC = useVariableStrategyPropsAsValueWithCallbacks(
    selectionVariableStrategy
  );
      ...
      if (fakedMove !== null) {
        if (fakedMove.loweringIndex !== null) {
          if (
            ...
            responses[fakedMove.loweringIndex] <=
              fakedMove.loweringIndexUpperTrigger
          ) {
        ...
        if (fakedMove.raisingIndex !== null) {
          if (
            ...
            responses[fakedMove.raisingIndex] >=
              fakedMove.raisingIndexLowerTrigger
          ) {
