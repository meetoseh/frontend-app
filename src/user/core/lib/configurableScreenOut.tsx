 ...
 */
export const configurableScreenOut = async <
  T extends string,
...
>(
  ...
  screenOut(
    ...
    transition,
    exit,
    trigger.type === 'flow' ? trigger.flow : null,
    {
      endpoint:
        trigger.type === 'flow' ? trigger.endpoint ?? undefined : undefined,
      parameters:
        trigger.type === 'flow' ? trigger.parameters ?? undefined : undefined,
