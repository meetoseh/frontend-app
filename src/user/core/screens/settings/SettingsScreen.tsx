  ...
  initInstanceResources: (ctx, screen, refreshScreen) => {
    const getIdentities = () =>
      createLoginContextRequest({
        ctx,
        handler: ctx.resources.identitiesHandler,
      });
    const identitiesRequest = createWritableValueWithCallbacks<RequestResult<
      Identity[]
    > | null>(null);
    ...
    const [identitiesUnwrapped, cleanupIdentitiesUnwrapper] =
      unwrapRequestResult(
        identitiesRequest,
        (d) => d.data,
        () => null
