...
export const searchPublicJourneyMapper: CrudFetcherMapper<
  SearchPublicJourney
> = (raw) => {
  ...
  return {
    ...
    instructor: convertUsingMapper(
      api.instructor,
      searchPublicJourneyInstructorMapper
    ),
    lastTakenAt:
    ...
    likedAt:
      api.liked_at === null || api.liked_at === undefined
        ? null
        : new Date(api.liked_at * 1000),
