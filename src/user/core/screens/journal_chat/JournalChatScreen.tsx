  ...
  initInstanceResources: (ctx, screen, refreshScreen) => {
    ...
    const cleanupChatFetcher = (() => {
      ...
      async function fetchChat(retry?: number) {
        ...
        const syncCancelable = syncToJournalEntry(
          user,
          entryUID,
          entryJWT,
          clientKey
        ...
        try {
          await Promise.race([
            syncCancelable.handlerCancelable.promise,
            canceled.promise,
          ]);
          ...
          if (
            ...
            const cancelableTimeout = createCancelableTimeout(
