...
> = {
  ...
  initInstanceResources: (ctx, screen, refreshScreen) => {
    ...
    const share = initImage({
      ...
      sizeMapper: (ws) => {
        ...
        const effectiveHeight =
          ws.height - ctx.topBarHeight.get() - ctx.botBarHeight.get();
    ...
    const shareableRequestVWC =
      createWritableValueWithCallbacks<RequestResult<JourneyShareableInfo> | null>(
        null
      );
    ...
    const [isShareableUnwrapped, cleanupUnwrapIsShareable] =
      unwrapRequestResult(
        shareableRequestVWC,
        (d) => d.data,
        () => null
            ...
            (s): Result<ExpirableJourneyRef> =>
              s.type !== 'success'
                ...
                : {
                    type: 'success',
                    data: {
                      journey: s.data.parameters.journey,
                      reportExpired: refreshScreen,
                    },
                    error: undefined,
                    retryAt: undefined,
    ...
    const likeStateVWC =
      createWritableValueWithCallbacks<RequestResult<JourneyLikeState> | null>(
        null
      );
