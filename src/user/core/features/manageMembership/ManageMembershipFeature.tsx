...
} from './ManageMembershipResources';
...
export const ManageMembershipFeature: Feature<
...
> = {
  ...
  useWorldState: () => {
    ...
    const syncRequiredVWC = useWritableValueWithCallbacks((): boolean => false);
          ...
          const parsedRecurrence: MMRecurrence | null =
            data.active_info === undefined || data.active_info === null
              ...
              : {
                  type: 'recurring',
                  period: {
                    iso8601: data.active_info.recurrence.period.iso8601,
                  },
                  cycleEndsAt: new Date(
                    data.active_info.recurrence.cycle_ends_at * 1000
                  ),
  ...
  component: (state, resources) => (
    <ManageMembership state={state} resources={resources} />
  ),
};
