...
export const SignupRewardFeature: Feature<
  SignupRewardState,
  SignupRewardResources
> = {
  ...
  useResources: (state, required) => {
        ...
        useMappedValuesWithCallbacks([required, interestsVWC], () => ({
          uid: (() => {
            ...
            if (
              ...
              interests.primaryInterest === "isaiah-course"
            ) {
    ...
    return useMappedValuesWithCallbacks(
      [session, givenNameVWC, image, interestsVWC],
      () => ({
        session: session.get(),
  ...
  component: (worldState, resources) => (
    <SignupReward state={worldState} resources={resources} />
  ),
};
