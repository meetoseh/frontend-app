...
const ERROR_TYPE_TO_MESSAGE: Record<
...
export class DisplayableError {
  ...
  formatProblem(): string {
    const eType = ERROR_TYPE_TO_MESSAGE[this.type] ?? {
      code: 'EUNK',
      msg: 'Unknown error',
    };
...
export const chooseErrorFromStatus = (
  status: number,
  action: string
): DisplayableError => {
  if (status === 429) {
  ...
  return (
    <View
      style={[
        ...
        { backgroundColor: OsehColors.v4.other.red },
      ]}
    >
              ...
              <Text
                style={[
                  ...
                  OsehStyles.colors.v4.primary.white,
                  {
                    ...
                    textDecorationColor: OsehColors.v4.primary.white,
                  },
                ]}
              >
                {cta.cta}
  ...
  <RenderGuardedComponent
    ...
    component={(e) =>
      e === null ? (
        ...
        <BoxError error={e} onDismiss={() => setVWC(errorVWC, null)} />
      )
    }
  />
);
  ...
  <RenderGuardedComponent
    ...
    component={(e) =>
      e === null ? (
        ...
        <ModalBoxError error={e} onDismiss={() => setVWC(errorVWC, null)} />
      )
    }
  />
);
