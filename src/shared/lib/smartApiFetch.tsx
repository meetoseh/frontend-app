...
export type SmartAPIFetchRetryerPreset =
  | 'never'
  | 'expo-backoff-3'
  | 'forever-5';
...
export const retryerExpoBackoff3 = createExponentialBackoffRetryer(
  1000,
  1000,
  3
);
...
export function createSmartAPIFetch<T extends {} | null>({
  ...
  const messageVWC =
    createWritableValueWithCallbacks<SmartAPIFetchMessage | null>(null);
