...
import { styles } from './RecordingBarsStyles';
        ...
        style={[
          styles.innerContainer,
          {
            ...
            ...(props.settings.align === 'right'
              ? {
                  right: -(props.settings.barSpacing + props.settings.barWidth),
                }
              : {
                  left: 0,
                }),
        ...
        <RenderGuardedComponent
          ...
          component={(offset) => (
            <HorizontalSpacer
              width={
                (1 - offset) *
                (props.settings.barSpacing + props.settings.barWidth)
              }
            />
          )}
        />
                ...
                <Fragment key={i}>
                  ...
                  <View
                    style={{
                      ...
                      paddingLeft: props.settings.barWidth,
